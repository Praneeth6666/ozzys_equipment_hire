/** Shared SEO copy — keep index.html FAQ JSON-LD in sync when editing FAQ_ITEMS */
...
export const SERVICE_AREAS = [
  ...
  'Geelong',
  'Ballarat & Bendigo',
  'Gippsland & regional Victoria',
];

export const USE_CASES = [
  'Festivals & outdoor events',
  'Sport & stadium activations',
  'Roadworks & traffic management',
  'Construction site messaging',
  'Retail & product launches',
  'Political & community campaigns',
...
export const INDUSTRIES = [
  ...
  'Councils and government campaigns',
